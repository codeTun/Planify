...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute top-10 -right-20 w-80 h-80 bg-purple-200/40 dark:bg-purple-900/20 rounded-full blur-3xl animate-float" />
      <div className="absolute bottom-10 -left-20 w-96 h-96 bg-blue-200/40 dark:bg-blue-900/20 rounded-full blur-3xl animate-float delay-500" />
      <div className="absolute top-1/3 left-1/3 w-64 h-64 bg-pink-200/20 dark:bg-pink-900/10 rounded-full blur-2xl animate-float delay-300" />
        ...
        <div className="max-w-md w-full">
          ...
          <div className="text-center mb-8 animate-fade-in-down">
            <Link href="/" className="inline-flex items-center space-x-2.5 mb-6 group">
              <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl flex items-center justify-center shadow-lg shadow-purple-500/25 group-hover:shadow-purple-500/40 transition-all duration-300 group-hover:scale-105">
            ...
            <h1 className="text-4xl font-extrabold text-gray-900 dark:text-white mb-2 tracking-tight">Create your account</h1>
            <p className="text-lg text-gray-500 dark:text-gray-400">Start managing your projects today</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">
                  Password <span className="text-gray-400 text-xs font-normal">(min. 6 characters)</span>
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-bold text-lg hover:shadow-lg hover:shadow-purple-500/25 hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:shadow-none"
              >
                {loading ? (
